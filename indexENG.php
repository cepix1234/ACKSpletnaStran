...
<?php 
	...
	$VseNoviceTxt = glob("./DropBoxNaServerju/ENG/novice/*.txt");
	$vseSlikeFolder = array_filter(glob("./DropBoxNaServerju/ENG/vse slike/*"), 'is_dir');
?>
    ...
    <div align="center">
        ...
        <div class="GlavniMenu" align="center">
        	<table class="GlavniMenuTabela">
                  <tr>
                    <button class="GlavniMenuG gumbGD" onclick="MenjavaStr('indexENG.php')">Domov</button>
                  </tr>
                    <tr>
